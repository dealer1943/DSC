...
- run: `stressD_20260914T013209Z_n512_GNG_preferential`
- N=512 neuropil=`GNG` seed=42
- scoreboard: fly_adj wins **0** · DSC wins **6**
- dsc_family: `preferential_directed` · experiment: `F025_exp5b_hard_default_stack`
...
| `tick_wall_us` | 1593.2294999999597 | 1630.6670000001411 |
...
| `E_tick` | 0.0005699249241434589 | 0.0005568203306003333 |
